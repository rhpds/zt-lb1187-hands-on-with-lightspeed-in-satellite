...
While this is a Red Hat Lightspeed in Satellite lab, this software is only a part of the overall Red Hat Lightspeed offering.  
...
There are thousands of CVEs - Red Hat Lightspeed helps you to focus on CVE information that pertains to Red Hat systems and some CVEs have gone through additional evaluation to share deep threat analysis specific to the version of RHEL your system is running.
...
Let’s say your security team knows about a vulnerability that affects WebKitGTK and they want to know if we have any systems with this vulnerability.  There are multiple CVEs on this issue, one such CVE number is   `CVE-2025-43458`.
...
Find and locate your system, then click the checkbox to the left of your system's name. +
...
Give your playbook a name like: `43458 fix {guid}`
...
Click the Download playbook button. +
...
Locate your host and click on the hostname. +
...
In the image below there are 21 CVEs with errata on the host in the image - the number you see may differ.
...
In the image below there are 2823 CVEs when looking at the full picture - these are CVEs with and without errata.  Having this information gives us a full view of all of the issues that affect your RHEL hosts - the ones you can fix as well as the ones you can’t.
